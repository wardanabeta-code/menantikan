...
const WishesMessagesSection: React.FC<WishesMessagesSectionProps> = ({
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 w-full max-w-full overflow-x-hidden overflow-y-hidden box-border" style={{ overflow: 'hidden' }}>
      <div className="max-w-4xl mx-auto max-w-full overflow-x-hidden overflow-y-hidden box-border" style={{ overflow: 'hidden' }}>
        {/* Section Title */}
        <motion.div
